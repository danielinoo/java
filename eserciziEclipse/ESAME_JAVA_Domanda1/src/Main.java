...
public class Main {
	...
	public static void main(String[] args) {
		...
		risposta_acquisto(c4, t1);
		System.out.println();
		
		//lista prodotti acquistati dai clienti
		c1.lista_p();
		c2.lista_p();
		c3.lista_p();
		c4.lista_p();
	...
	private static void risposta_acquisto(Cliente c, Prodotto p) {
		...
		//prende un negozio random
		String rr = p.negozio_random();
		
		// TODO Auto-generated method stub
		String r = c.Acquisto(p); //effettuo l acquisto del prodotto e prento r (risposta)
		
		System.out.println(c.nome + " " + c.cognome + " " + r +  " " + p.nome +  " nel " + rr );
		System.out.println();
