...
public class Cliente {
	...
	public void lista_p() { //cicla i prodotti acquistati
		System.out.println("lista di acquisti " +" " + nome +" " +  cognome);
	    for (Prodotto p : prodotti_acqustati) {
